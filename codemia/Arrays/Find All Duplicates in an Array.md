...
`num=4: index=3, nums[3]=7>0, negate → [4,3,2,-7,8,2,3,1] num=3: index=2, nums[2]=2>0, negate → [4,3,-2,-7,8,2,3,1] num=2: index=1, nums[1]=3>0, negate → [4,-3,-2,-7,8,2,3,1] num=-7: index=6, nums[6]=3>0, negate → [4,-3,-2,-7,8,2,-3,1] num=8: index=7, nums[7]=1>0, negate → [4,-3,-2,-7,8,2,-3,-1] num=2: index=1, nums[1]=-3<0, DUPLICATE! Add 2 num=-3: index=2, nums[2]=-2<0, DUPLICATE! Add 3 num=-1: index=0, nums[0]=4>0, negate → [-4,-3,-2,-7,8,2,-3,-1] Result: [2, 3] ✓`
**Why This Works:**  
